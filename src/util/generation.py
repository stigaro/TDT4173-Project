...
from tensorflow.keras.layers import SimpleRNN, GlobalMaxPool1D
...
class Generator:
    ...
    def generate_rnn_simple(hp):
        ...
        hp_embed_dim = hp.Int('embedding_dimension', min_value=8, max_value=64, step=8)
        ...
        hp_units = hp.Int('rnn_units', min_value=8, max_value=256, step=8)
