...
class Generator:
    ...
    def generate_rnn_simple(hp):
        ...
        hp_embed_dim = hp.Int('embedding_dimension', min_value=8, max_value=32, step=8) # embed_dim = 16
        ...
        hp_units = hp.Int('rnn_units', min_value=8, max_value=128, step=8) # units = 128
        ...
        rnn_s.add(SimpleRNN(hp_units, activation= 'sigmoid'))
    ...
    def generate_rnn_bidirect(hp):
        ...
        rnn_b.add(keras.layers.Bidirectional(SimpleRNN(hp_units, activation='sigmoid')))
